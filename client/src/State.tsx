 ...
 */
const instruments = List([PianoInstrument,GuitarInstrument, ClarinetInstrument]);       // similar to Instrument[]

/**
 * Start with the default waveform visualizer.
 * Add your visualizers to this list.
 */
const visualizers = List([WaveformVisualizer, FlowerVisualizer, OvalVisualizer]);    // similar to Visualizer[]
