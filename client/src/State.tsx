 ...
 */
const instruments = List([PianoInstrument,GuitarInstrument, ClarinetInstrument, TromboneInstrument]);       // similar to Instrument[]

/**
 * Start with the default waveform visualizer.
 * Add your visualizers to this list.
 */
const visualizers = List([WaveformVisualizer, FlowerVisualizer, OvalVisualizer, DrashtiShah23Visualizer]);    // similar to Visualizer[]
