...
import { fbSize, fretPositions, stringPositions } from './fretboardValues.js';
import * as Tone from 'tone';
import { playNote, isMuted } from './sounds.js';
    ...
    return (
        <div className="fret-markers">
            <svg
                ...
                onMouseDown={() => synth?.triggerAttack(playNote(string, fret))}
                onMouseUp={() => {synth?.triggerRelease('+0.25'); updateCurrFrets(string, fret)}}
